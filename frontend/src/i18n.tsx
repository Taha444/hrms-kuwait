...
const dict: Record<string, { ar: string; en: string }> = {
  ...
  eos_unused_leave: { ar: "رصيد إجازات غير مستخدم", en: "Unused Leave Days" }, eos_divisor: { ar: "المقسوم", en: "Divisor" },
  ...
  user_data_scope: { ar: "نطاق البيانات (تقييد بفرع):", en: "Data scope (branch restriction):" },
