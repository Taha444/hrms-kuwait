...
('الهيئة العامة للقوى العاملة — خدمة أسهل', 'PAM — Ashal Service',
 ...
 'https://www.manpower.gov.kw/Pages/Services/Ashal.aspx', 'manpower', '👷', 10, true, NOW(), NOW()),
...
('الخدمات الإلكترونية للهيئة العامة للقوى العاملة', 'PAM E-Services',
 ...
 'https://www.manpower.gov.kw/EServices.aspx', 'manpower', '📄', 20, true, NOW(), NOW()),

('استفسارات خدمة أسهل', 'Ashal Enquiries',
 'الاستفسارات والدعم الخاص بخدمة أسهل',
 'Support and enquiries for the Ashal service',
 'https://www.manpower.gov.kw/Pages/Services/EnquiriesForAshal.aspx', 'manpower', '❓', 30, true, NOW(), NOW()),
...
('منصة الخدمات الإلكترونية لوزارة الداخلية', 'MOI E-Services Portal',
 ...
 'https://eres.moi.gov.kw/', 'residency', '🛂', 10, true, NOW(), NOW()),
...
('منصة خدمات الأفراد — وزارة الداخلية', 'MOI Individual Services',
 ...
 'https://eres.moi.gov.kw/individual', 'residency', '👤', 20, true, NOW(), NOW()),
...
('تحويل الإقامة للشركات', 'Residency Transfer for Companies',
 ...
 'https://eres.moi.gov.kw/companies/residency/transfer/', 'residency', '🔄', 30, true, NOW(), NOW()),
...
('الهيئة العامة للمعلومات المدنية (PACI) — الرئيسي', 'PACI Main Site',
 ...
 'https://www.paci.gov.kw/', 'civil_id', '🏛️', 5, true, NOW(), NOW()),
...
('الخدمات الإلكترونية — PACI', 'PACI E-Services',
 ...
 'https://services.paci.gov.kw/', 'civil_id', '🪪', 10, true, NOW(), NOW()),
...
('الاستعلام عن البطاقة المدنية وحالتها', 'Civil ID Card Inquiry',
 ...
 'https://services.paci.gov.kw/card/inquiry?lang=ar&serviceType=4', 'civil_id', '🔍', 20, true, NOW(), NOW()),
...
('دليل معاملات الهيئة العامة للمعلومات المدنية', 'PACI Applications Guide',
 ...
 'https://services.paci.gov.kw/applications-guide', 'civil_id', '📘', 30, true, NOW(), NOW()),
...
('تغيير عنوان غير كويتي', 'Change of Address – Non-Kuwaiti',
 ...
 'https://services.paci.gov.kw/applications-guide/detail/change-of-address-%28non-kuwaiti%29/16', 'civil_id', '📍', 40, true, NOW(), NOW()),
...
('نموذج إقرار السكن (PDF)', 'Address Declaration Form (PDF)',
 ...
 'https://services.paci.gov.kw/pdf/Address-Declaration.pdf', 'civil_id', '📥', 50, true, NOW(), NOW()),
...
('تطبيق هويتي — Kuwait Mobile ID', 'Hawyti — Kuwait Mobile ID',
 ...
 'https://hawyti.paci.gov.kw/', 'civil_id', '🔐', 60, true, NOW(), NOW()),
...
('وزارة التجارة والصناعة — الخدمات الإلكترونية', 'MOCI E-Services',
 ...
 'https://www.moci.gov.kw/ar/e-service/', 'moci', '🏢', 10, true, NOW(), NOW()),
...
('السجل التجاري ورخص الاستيراد', 'Commercial Registry & Import Licenses',
 ...
 'https://www.moci.gov.kw/ar/e-service/electronic-services-managing-commercial-registry/', 'moci', '📜', 20, true, NOW(), NOW()),
...
('مركز الكويت للأعمال — تأسيس الشركات', 'Kuwait Business Center',
 ...
 'https://www.moci.gov.kw/ar/e-service/kuwait-business-center/', 'moci', '🏗️', 30, true, NOW(), NOW()),
...
('تعديل وتجديد تراخيص شركات الأشخاص', 'Persons'' Companies Licenses',
 ...
 'https://moci.gov.kw/ar/e-service/digital-portal-managing-peoples-companies/', 'moci', '🔧', 40, true, NOW(), NOW()),
...
('بلدية الكويت — الرئيسي', 'Kuwait Municipality — Main',
 ...
 'https://www.baladia.gov.kw/', 'municipality', '🏛️', 10, true, NOW(), NOW()),
...
('الاستعلام عن حالة معاملات تراخيص المحلات', 'Shop License Transactions Inquiry',
 ...
 'https://kmapi.baladia.gov.kw/KMShopQuery/default.aspx', 'municipality', '🔍', 20, true, NOW(), NOW()),
...
('الإدارة العامة للجمارك', 'General Customs Directorate',
 ...
 'https://www.customs.gov.kw/', 'customs', '🛃', 10, true, NOW(), NOW()),
...
('تسجيل أو تجديد شركة لدى الجمارك', 'Company Registration/Renewal — Customs',
 ...
 'https://www.customs.gov.kw/Home/orgstatusrequest', 'customs', '📝', 20, true, NOW(), NOW()),
...
('المؤسسة العامة للتأمينات الاجتماعية (PIFSS)', 'PIFSS — Main',
 ...
 'PIFSS main website',
 'https://www.pifss.gov.kw/', 'insurance', '🛡️', 10, true, NOW(), NOW()),
...
('بوابة أصحاب الأعمال — التأمينات', 'PIFSS Business Portal',
 ...
 'https://www.pifss.gov.kw/sites/Ar/Pages/eServices/BusinessPortal.aspx', 'insurance', '💼', 20, true, NOW(), NOW()),
...
('غرفة تجارة وصناعة الكويت (KCCI) — الخدمات', 'KCCI E-Services',
 ...
 'https://webservices.kcci.org.kw/', 'other_services', '🏛️', 10, true, NOW(), NOW()),
...
('KCCI — تسجيل / إنشاء حساب', 'KCCI — Register / Sign-up',
 ...
 'https://webservices.kcci.org.kw/progeservices/register/first/M', 'other_services', '🔑', 20, true, NOW(), NOW()),
...
('وزارة الصحة الكويتية', 'Ministry of Health',
 ...
 'https://www.moh.gov.kw/', 'other_services', '🏥', 30, true, NOW(), NOW()),
...
('وزارة الخارجية الكويتية', 'Ministry of Foreign Affairs',
 ...
 'https://www.mofa.gov.kw/ar/', 'other_services', '🌐', 40, true, NOW(), NOW()),
...
('البوابة الإلكترونية الرسمية لدولة الكويت', 'Kuwait Official e-Gov Portal',
 ...
 'https://www.e.gov.kw/', 'other_services', '🇰🇼', 50, true, NOW(), NOW()),
...
('دليل خدمات قطاع الأعمال (e.gov)', 'Business e-Services Directory',
 ...
 'https://www.e.gov.kw/sites/kgoenglish/Pages/Business/Eservices.aspx', 'other_services', '📚', 60, true, NOW(), NOW())
""")
...
def downgrade() -> None:
    ...
    op.execute("""
        ...
        ('بوابة مدني (PACI)', 'PACI Portal', 'الهيئة العامة للمعلومات المدنية', 'https://www.paci.gov.kw/', 'civil_id', 10, true, NOW(), NOW()),
        ('ساحل — الخدمات الحكومية', 'Sahel Portal', 'بوابة ساحل الحكومية الشاملة', 'https://sahel.gov.kw/', 'other', 5, true, NOW(), NOW()),
        ('وزارة التجارة والصناعة', 'MOCI Portal', 'رخص تجارية', 'https://www.moci.gov.kw/', 'moci', 20, true, NOW(), NOW()),
        ('هيئة القوى العاملة (PAM)', 'PAM', 'إذن العمل', 'https://www.pam.gov.kw/', 'work_permits', 30, true, NOW(), NOW()),
        ('الإدارة العامة للإقامة', 'DGR', 'تجديد الإقامات', 'https://moi.gov.kw/', 'residency', 40, true, NOW(), NOW()),
        ('البلدية', 'Kuwait Municipality', 'تراخيص المحلات', 'https://www.baladia.gov.kw/', 'municipality', 50, true, NOW(), NOW()),
        ('PIFSS', 'PIFSS', 'اشتراكات التأمينات', 'https://www.pifss.gov.kw/', 'insurance', 60, true, NOW(), NOW())
    """)
