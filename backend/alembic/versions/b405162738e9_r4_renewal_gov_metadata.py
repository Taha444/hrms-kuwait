...
def upgrade() -> None:
    add_column("residency_renewals", sa.Column("gov_reference_no", sa.String(60), nullable=True))
    add_column("residency_renewals", sa.Column("fees_amount", sa.Float(), nullable=True))
    add_column("residency_renewals", sa.Column("fees_receipt_no", sa.String(60), nullable=True))
    add_column("residency_renewals", sa.Column("new_permit_number", sa.String(60), nullable=True))
    add_column("residency_renewals", sa.Column("new_expiry_date", sa.Date(), nullable=True))
    add_column("residency_renewals", sa.Column("finalized_at", sa.DateTime(), nullable=True))
    add_column("residency_renewals",
                  sa.Column("finalized_by", sa.Integer(), sa.ForeignKey("users.id"), nullable=True))
    add_column("residency_renewals", sa.Column("hr_verified_at", sa.DateTime(), nullable=True))
    add_column("residency_renewals",
                  sa.Column("hr_verified_by", sa.Integer(), sa.ForeignKey("users.id"), nullable=True))
    add_column("residency_renewals", sa.Column("hr_verification_note", sa.Text(), nullable=True))
