...
<p>يعتبر التمهيد السابق جزء لا يتجزأ من هذا العقد . .</p>
...
<p>هذا العقد محدد المدة او غير محدد المدة يخضع لإرادة الطرفين .</p>
</div>
"""
...
راحة لا تقل عن ساعة باستثناء الحالات المقررة قانونا .</p>

<p style="text-align:center"><strong>البند التاسع</strong><br/><strong>" قيمة تذكرة السفر "</strong></p>
<p>تحمل الطرف الأول مصاريف عودة الطرف الثاني إلى بلده عند انتهاء علاقة العمل ومغادرته
نهائيًا للبلاد .</p>
...
<p>تسري أحكام قانون العمل في القطاع الأهلي رقم 6 لسنة 2010 والقرارات المنفذة له فيما لم
يرد بشأنه نص في هذا العقد ، ويقع باطلًا كل شرط تم الاتفاق عليه<br/>
...
<p>حرر هذا العقد باللغتين العربية و الإنجليزية ، ويعتد بنصوص اللغة العربية عند وقوع أي
تعارض بينهما .</p>

<p style="text-align:center"><strong>البند السادس عشر</strong><br/><strong>" نسخ العقد "</strong></p>
<p>حرر هذا العقد من ثلاث نسخ كل طرف نسخة للعمل بموجبها والثالثة  تودع لدى الهيئة العامة
للقوى العاملة .</p>
