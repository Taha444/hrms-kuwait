...
**ولا يُصلَح هنا**: أيُّ الحالات تُدفَع قرارٌ ماليٌّ وقانوني (والإيقافُ
بأجرٍ أو بدونه بحسب سببه). فيُقاس ويوضَع أمام صاحب القرار.
...
def main() -> int:
    ...
    if rows:
        ...
        print("\nلا أحد — والبندُ بنيويٌّ: أوّلُ «في إجازة» أو تسويةٍ قبل المسيّر يُنشئه.")
    print("\n— ولا يُصلَح هنا: أيُّ الحالات تُدفَع قرارٌ ماليٌّ وقانوني.")
    return 0
