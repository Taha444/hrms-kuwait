...
_KNOWN_SILENT = {
    "REQWP": "القاعدة 12 — الإذن تُصدره الهيئة، وورقٌة بشكله انتحاُل صفة (DOC-11).",
    "REQPASS": "OD-013 غلاُف متابعٍة داخلي — على خطّ القاعدة 12، قراٌر معلَّق.",
    "REQCID": "OD-013 غلاُف متابعٍة داخلي — على خطّ القاعدة 12، قراٌر معلَّق.",
