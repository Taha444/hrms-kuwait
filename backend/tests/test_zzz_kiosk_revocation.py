...
def test_the_declared_defence_is_still_optional_for_qr_mode():
    ...
    وحسم المالك (2026-09-18): الموقع إلزامٌي للرمز الثابت **حيث للفرع
    إحداثيات** — في ``validate_qr`` لا هنا (``test_zzz_static_qr_location``).
    والفرع بلا إحداثيات يبقى بلا قياس، فيبقى هذا الشرط قائًما.
    """
