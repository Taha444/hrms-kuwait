...
SCHEMAS.update({
    ...
    "ADMWARN": {
        "fields": [
            ...
            _field("effective_date", "تاريخ السريان", "date", required=True),
            # **مهلُة الرد — حُسمت (قرار المالك 2026-09-18).** بانقضائها
            # بلا ردٍّ من الموظف (``REQWARN``) يُنشئ المسحُ اليومي مهمًة لـHR
            # «انقضت مهلة الرد بلا رد» — **ولا قراَر آليّ**: الإنذار لا
            # يُغلَق ولا يُبنى عليه شيء. انظر ``notifications.daily_scan``.
            # يحرسه ``test_zzz_warning_no_reply.py``.
