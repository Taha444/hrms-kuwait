...
DEFAULT_NOTIFICATION_TEMPLATES = [
    ...
    #
    # الاتفاقية تُطبع موقَّعة من صورة توقيع الموظف المحفوظة، أو بخطٍّ فارغ
    # إن لم تكن له صورة. وكنتُ فرّقتُ الرسالة بالحال — «جاهز للاستلام»
    # لمن وقّعت صورتُه و«مطلوب حضورك للتوقيع» لغيره — فاختار المالك
    # جملًة واحدة تسع الحالين، وهي أقرب إلى ما يقع فعًلا: الموظف يذهب
    # إلى الشؤون في الحالين، وهناك يُعرَف أيوقّع أم يستلم.
    _n("NTF-075", "اتفاقية سلفة أو قرض جاهزة", CAT_FINANCE, "loan_agreement_ready",
      "in_app", 72,
      "راجع شؤون الموظفين لتوقيع اتفاقية «{{request_type}}» أو استلامها."),
