...
#
# قرار العميل: HR وحده. هو الجهة المخوَّلة بفتح الإجراءات باسم الموظفين
# والمسؤولين جميعًا؛ وكل دور آخر — بما فيه مدير الشركة والمحاسب والمندوب
# ومسؤول الفرع — يقدّم لنفسه فقط مهما كانت صلاحياته الأخرى.
#
