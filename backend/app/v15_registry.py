...
#:
#: **وما لا أقطع به لا يُدرَج:**
#:
#: - ``REQPASS``: جواُز الوافد يصدر من سفارة بلده، والمعاملُة عندنا تحديُث
#:   بياناته على اإلقامة. فالجهُة تتبع الجنسيَّة والشقَّ المقصود — قراُر
#:   مالٍك لا استنباُط شيفرة.
#: - ``leave`` (إذن مغادرة البلاد): جهتُه بين الداخلية والقوى العاملة —
#:   ولا يُسمّى بالظنّ.
#:
#: وغياُب السطر مكتوٌب في ``_gov_cover_lines``: «غلاٌف لا يسمّي الجهَة
#: أهوُن من غلاٍف يسمّي جهًة خاطئة».
