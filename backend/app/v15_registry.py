...
OUTPUT_GAPS: dict[str, dict] = {
    ...
    # **تصحيٌح لتصنيفي الأول**: صنّفتُ هذه «ربًطا» لأن ``OD-018`` له قوالب.
    # والقياس عند التنفيذ قال غير ذلك: ``OD-018`` يغطّي أربع صور
    # (استئذان · تصحيح حضور · إضافي · عودة) وقوالبه اثنان فقط — «تكليف
    # واعتماد عمل إضافي» و«إشعار عودة من إجازة». فالاستئذان وتصحيح الحضور
    # **بلا قالب**، والتصنيف كان يقيس المستند لا صورته.
    "WF-003/OD-018": {"needs": "profile_template", "why": "إيصال استئذان — صورٌة من OD-018 بلا قالب (قوالبه للإضافي والعودة)."},
    "WF-004/OD-018": {"needs": "profile_template", "why": "إيصال تصحيح حضور — صورٌة من OD-018 بلا قالب، والسجلّ يشترط سجلّ before/after."},
    "WF-007/OD-021": {"needs": "profile_template", "why": "إشعار تحديث بيانات شخصية — قوالب OD-021 هي «شهادة حالة وظيفية» و«خطاب تحويل راتب للبنك»، وليس فيهما إشعار تحديث."},
    "WF-008/OD-021": {"needs": "profile_template", "why": "إشعار تغيير حساب بنكي بـIBAN مقنَّع وشهر نفاذ — ولا قالب لهذه الصورة، والسجلّ يشترط ألّا يفعّله من أدخله."},
