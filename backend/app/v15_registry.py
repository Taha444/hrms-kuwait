...
OUTPUT_GAPS: dict[str, dict] = {
    ...
    "WF-012/OD-024": {"needs": "signature_decision", "why": "قرار اعتراض خصم — كسابقه: رايُة التوقيع مفعَّلة، فالإصدار يحوّله إلى انتظار توقيع."},
    ...
    "WF-008/OD-021": {"needs": "signature_decision", "why": "إشعار تغيير حساب بنكي — إصداُره يحوّل الطلب إلى انتظار توقيٍع ورقّي (رايُة التوقيع مفعَّلة)، وهو تغيٌّر في المسار لا إصداُر ورقة."},
