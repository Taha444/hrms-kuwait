...
OUTPUT_GAPS: dict[str, dict] = {
    ...
    "WF-002/OD-013": {"needs": "wiring",
                      "why": ("غلاف متابعة حكومية للسفر. والمندوُب **يرفع إذَن "
                              "المغادرة الحقيقي** (upload_exit_permit) لا "
                              "يولّده النظام — فالقاعدة 12 محفوظة، والسؤاُل هو "
                              "سؤاُل الغلاف الداخلي نفسه: النظاُم يُنتج OD-013 "
                              "فعًلا لتجديد الإقامة (REQRESE وREQRESN بقالب "
                              "HRMS-PR-034) وللمهمة الخارجية (REQMIS)، ولا "
                              "يُنتجه للسفر ولا لإذن العمل ولا للجواز ولا "
                              "للبطاقة. **فالنظاُم غيُر متّسق مع نفسه**، "
                              "والقراُر واحٌد لأربعتها لا أربعة قرارات "
                              "(القاعدة 12). وكان مسجًَّلا هنا كسؤاٍل عن بنية "
                              "المسار — «أثٌر تابع أم مخرٌج مستقل» — وهو فرٌع "
                              "من ذلك القرار لا سؤاٌل مستقل."),},


    "WF-021/OD-013": {"needs": "wiring", "why": "تجديد إذن عمل. **والرفُض مكتوٌب عند REQWP** (DOC-11): ورقٌة بشكل الإذن انتحاُل صفة. لكنّ النظاَم **يُنتج OD-013 فعًلا** في ثالثة مسارات: تجديد الإقامة المبكر والعادي (REQRESE وREQRESN بقالب HRMS-PR-034) والمهمة الخارجية (REQMIS). وتجديُد الإقامة حكومٌّي بقدر إذن العمل — **فالنظاُم غيُر متّسق مع نفسه**: إمّا الغالُف الداخلي آمٌن فتُنتجه الثالثُة كما تُنتجه الإقامة، وإمّا ال فتُرفَع عن الإقامة أيًضا. قراٌر لصاحبه (القاعدة 12)."},
    "WF-022/OD-013": {"needs": "wiring", "why": "تحديث جواز. لكنّ النظاَم **يُنتج OD-013 فعًلا** في ثالثة مسارات: تجديد الإقامة المبكر والعادي (REQRESE وREQRESN بقالب HRMS-PR-034) والمهمة الخارجية (REQMIS). وتجديُد الإقامة حكومٌّي بقدر إذن العمل — **فالنظاُم غيُر متّسق مع نفسه**: إمّا الغالُف الداخلي آمٌن فتُنتجه الثالثُة كما تُنتجه الإقامة، وإمّا ال فتُرفَع عن الإقامة أيًضا. قراٌر لصاحبه (القاعدة 12)."},
    "WF-023/OD-013": {"needs": "wiring", "why": "تحديث بطاقة مدنية. لكنّ النظاَم **يُنتج OD-013 فعًلا** في ثالثة مسارات: تجديد الإقامة المبكر والعادي (REQRESE وREQRESN بقالب HRMS-PR-034) والمهمة الخارجية (REQMIS). وتجديُد الإقامة حكومٌّي بقدر إذن العمل — **فالنظاُم غيُر متّسق مع نفسه**: إمّا الغالُف الداخلي آمٌن فتُنتجه الثالثُة كما تُنتجه الإقامة، وإمّا ال فتُرفَع عن الإقامة أيًضا. قراٌر لصاحبه (القاعدة 12)."},
}
