...
class Settings(BaseSettings):
    ...
    #: العنوان العامّ للنظام — يُستعمَل في رمز التحقّق المطبوع.
    #:
    #: **ورمٌز بلا طريق لا يُتحقَّق به**: رمز QR أسفل كل مستند رسمي كان
    #: يحمل النصّ المجرَّد (``12-ab34cd``)، فالبنك الذي يمسحه يحصل على
    #: سلسلة حروٍف لا تقوده إلى شيء — ولا شاشَة تحقٍّق في الواجهة ولا سطَر
    #: على الورقة يقول أين يذهب.
    #:
    #: وفراُغه يُبقي السلوك القديم (الرمز المجرَّد): بيئٌة لم تُضبَط لا
    #: يُطبَع فيها رابٌط خاطئ يقود إلى لا شيء.
    public_base_url: str = ""
