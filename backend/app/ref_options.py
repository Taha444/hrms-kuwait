...
#:
#: P11-37 — و``employee_ref`` كان ناقًصا من هنا، وهو نوع حقٍل واحد في
#: النظام كلّه: «المُشتكى منه (اختياري)» في نموذج الشكوى. فيُعرَض عنواُنه
#: وقائمٌة **فارغة** — سؤاٌل لا يمكن جوابه. ثم لا يُقرأ الجواب لو كُتب،
#: ثم ينظر المشكو منه الشكوى ضدّه لأنه معتمِد المرحلة. ثلاث طبقات،
#: وإصلاُح إحداها وحدها تمثيل.
#:
#: والقائمة مقصورٌة على الشركة كبقية المراجع، ولا تُبنى إلا للمخطّط الذي
#: يعلن الحقل — فلا يصير دليُل الموظفين مكشوًفا في كل نموذج.
_SOURCES = {
    "branch_ref": (models.Branch, "name"),
    "shift_ref": (models.Shift, "name"),
    "license_ref": (models.License, "name"),
    "employee_ref": (models.Employee, "name"),
}
        ...
        if ftype.endswith("_ref") and ftype in _SOURCES:
            ...
            if not opts:
                ...
                f["setup_required"] = {
                    ...
                    "employee_ref": "لا موظفين معرَّفين بعد",
