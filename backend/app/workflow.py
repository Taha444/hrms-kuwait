...
DEFAULT_REQUEST_TYPES = [
    {
        ...
        # **قرار المالك**: قرار الإجازة يصدر فوًرا ولا ينتظر توقيًعا يدوًيا.
        #
        # وتوقيع الموظف **مدموج في المستند أصًلا**: التوليد يسحب
        # ``signature_path`` من حسابه ويضعه في موضعه (انظر
        # ``generate_document``). فالانتظار كان يطلب توقيًعا ثانًيا باليد
        # على ورقة تحمل توقيعه مطبوًعا.
        #
        # وبقاؤه سابًقا لم يكن اختياًرا: كان النوع **الوحيد** الذي يقف
        # للتوقيع قبل P5-23، فاستمرّ بحكم الحال لا بقرار.
        #
        # والعقود تبقى كما هي (REQRESIGN · REQEOS · REQCLR): تُقدَّم
        # لجهات تشترط توقيًعا حًيا، وتُحتجّ بها في نزاع.
